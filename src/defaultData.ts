...
export const defaultSettings: SiteSettings = {
  title: "루비솔루션 | 프리미엄 로고디자인 & 광고·PR 에이전시",
  subtitle: "RUBY SOLUTION",
  heroTitle: "생각을 관통하는 디자인,\n가치를 증명하는 브랜딩",
  heroSubtitle: "루비솔루션은 브랜드의 깊이에 섬세함을 더합니다. 단순한 로고 제작을 넘어 기업 고유의 헤리티지를 담은 럭셔리 비주얼 정체성과 트렌드를 주도하는 종합 광고/PR 전략을 기획합니다.",
  heroCtaText: "텔레그램 문의하기",
  accentColor: "#e11d48", // Ruby Red! Rose-600 / e11d48 color is beautiful and matches a premium ruby shade! Let's make the accent color a sophisticated ruby red! Rose-600 is very elegant and high-tech lux!
  fontStyle: "sans",
  email: "contact@ruby.solution",
  phone: "02-1234-5678",
  address: "서울특별시 강남구 테헤란로 518, 디타워 14층",
  kakaoLink: "https://open.kakao.com/o/sRubySolutionMock",
  instagramLink: "https://instagram.com/ruby.solution",
  telegramLink: "https://t.me/ruby_solution",
  servicesSubtitle: "OUR EXPERTISE",
  servicesTitle: "루비솔루션의 독보적인\n크리에이티브 대행 설계",
  ...
  service1Desc: "브랜드가 가진 단 하나의 철학을 정교하고 럭셔리하게 시각화합니다. 루비솔루션의 로고 디자인은 단순 기호 축소를 넘어, 수십 년 간 지속될 가치를 창조합니다.",
  ...
  portfolioDesc: "미적 아름다움은 기본입니다. 루비솔루션의 비주얼 포트폴리오는 비즈니스 돌파의 핵심 단서와 감동적 일체감을 자극합니다.",
  blogSubtitle: "INSIGHTS & NOTICES",
  blogTitle: "루비 디자인 트렌드 & 칼럼",
  blogDesc: "로고 디자인 마켓의 핵심 인사이트와 효과적인 마케팅 PR 전략 및 루비솔루션의 새로운 공지사항을 연재합니다.",
  footerDesc: "루비솔루션은 아너링크, 씨맥스, 스윅스, 인베스트, 이글, 더넛츠, 아이지메타등 게이밍본사와의 정식 계약을통해 영상 송출 및 국내 최저가의 카지노 알 공급을하며 심리스 또는 트렌스터 방식운영까지 운영환경에 맞춰 진행하는 최상위 맞춤형 솔루션 업체입니다",
  footerTitle: "루비솔루션(RubySolution)",
  representative: "루비솔루션",
  contactTitle: "새로운 성공의 궤적을 그리다",
  contactDesc: "로고 디자인부터 타겟 맞춤 광고 매체 PR 대행까지, 루비솔루션의 디자인 사단과 마케팅 연구소가 동행할 프로젝트에 대한 의뢰를 접수합니다.",
...
루비솔루션은 수십 가지 디바이스와 조명, 질감 테스트를 선제 검증하여 언제 어디서나 극상의 품격을 뿜어내는 '에센셜 비주얼 밸런스'를 기획합니다.`,
...
루비솔루션의 홍보 PR 솔루션은 감각적인 크리에이티브 시안에 철저히 논증된 시장 검증 데이터 마크를 결합하여 고객 브랜드의 평판을 고급화하고 잠재 투자 사를 강하게 소환하는 최고의 전술을 정합 지원합니다.`,
    createdAt: "2026-06-01"
  },
  {
    id: "blog-3",
    title: "루비솔루션, '크리에이티브 코리아 2026' 최고의 브랜딩 에이전시 선정",
    category: "공지사항",
    author: "루비 대표 관리자",
    summary: "루비솔루션이 뛰어난 디자인 역량과 통합 PR 솔루션을 인정받아 올해 우수 브랜딩 파트너 대상을 수여하였습니다.",
    imageUrl: "https://images.unsplash.com/photo-1542744094-3a31f103e35f?w=800&q=80",
    content: `안녕하세요, 루비솔루션 프리미엄 에이전시입니다.

언제나 당사를 아껴주시고 동반자적 신뢰를 아낌없이 보내주시는 크리에이티브 파트너사와 클라이언트 여러분께 깊은 소통의 감사를 드립니다.

당사 루비솔루션이 디자인 혁신과 마케팅 홍보 시너지의 탁월함을 업계 선도로 인정받아, 한국마케팅디자인협회가 주관하는 **[크리에이티브 코리아 2026 (Creative Korea 2026)]**에서 '올해의 우수 디자인 및 광고 PR 에이전시 대상'을 정식 수상하였습니다.

특히, 대기업 지주사의 성공적인 종합 리브랜딩부터 스타트업의 신규 심볼 런칭을 담당하며 단 한 건의 클레임이나 소송 이슈 없이 99% 최고의 만족도 평점을 달성한 성과가 매우 높게 반영되었습니다.

저희 루비솔루션 임직원 일동은 이에 안주하지 않고, 매 시안마다 가업의 역사를 짓는 웅장한 신성함으로 최고의 감동과 비주얼 전율을 선사해 드릴 것을 엄숙히 약속드립니다.
